...
# TODO: Update this with heatmaps per layer, starting with first layer
heatmap_per_layer = [
...
def skip_computation_pre(self, input):
    # print("Using heatmap: ", conv_layer_count)
    heatmap_size = 8
    heatmap = heatmap_per_layer[conv_layer_count]
    ...
    for region_idx in lowest_regions_to_skip:
      ...
      if total_pixels_to_skip > region_size:
        input[0].data[:,:, y: int(y + scale_factor), x: int(x + scale_factor)] = 0
    ...
    print("The percentage of zero pixels: " + str(total_pixels_skipped / total_pixels))
